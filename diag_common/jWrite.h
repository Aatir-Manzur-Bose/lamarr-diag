...
int jWriteFile ( struct jWriteControl *jwc, char *pFileName);
int jWriteFileReset (char *pFileName, char *pStr);
void ErrorDisplay (int err);
void jwArr_double_json_int( struct jWriteControl *jwc,  char *key, double value );
void jwArr_int_json_int(  struct jWriteControl *jwc,  char *key, int value );
void jwArr_raw_json_int(  struct jWriteControl *jwc,  char *key, char *rawtext );
void jwArr_array_json_int(  struct jWriteControl *jwc, char *key );
